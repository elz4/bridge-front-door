# bridge-front-door
Code and work related to a front door for refugee services.
...
2. Install the relevant google tools (`pip install --upgrade google-cloud-texttospeech` and `pip install --upgrade google-genai`). Recommend using venv.
